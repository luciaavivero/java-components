...
public class SystemPerformanceData extends BaseIotData implements Serializable
{
	...
	protected void handleUpdateData(BaseIotData data)
	{
		if (data instanceof SystemPerformanceData) {
			SystemPerformanceData yData = (SystemPerformanceData)data;
			this.setCpuUtilization(yData.getCpuUtilization());
			this.setDiskUtilization(yData.getDiskUtilization());
			this.setMemoryUtilization(yData.getMemoryUtilization());
		}
	}
